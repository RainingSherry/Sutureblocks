...
def pure_infsa_scores(
    ...
    Args:
        ...
        rho: Decay parameter in (0, 1). Controls the spectral radius of A.                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
    ...
    A = torch.matmul(q_scaled, k_scaled.transpose(-2, -1))  # (..., N, N)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
    A = torch.relu(A)
...
def linear_infsa_scores(
    ...
    """Compute linear InfSA attention scores via eigenvector approximation.                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
    ...
    a = torch.relu(torch.einsum("...d,...nd->...n", q_bar, k_scaled))  # (..., N)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
...
def infsa_attention(
    ...
    if variant == "pure_infsa":
        scores = pure_infsa_scores(q, k, rho=rho, eps=eps)  # (..., N, N)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
