...
class ScharrConv(nn.Module):
    def __init__(self, channel):
        ...
        self.scharr_kernel_x_conv = nn.Conv2d(channel, channel, kernel_size=3, padding=1, groups=channel, bias=False)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
        self.scharr_kernel_y_conv = nn.Conv2d(channel, channel, kernel_size=3, padding=1, groups=channel, bias=False)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
...
class SFEM(nn.Module):
    def __init__(self, in_channels):
        ...
        self.fft_conv = Conv(in_channels * 2, in_channels * 2, 3)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
    ...
    def forward(self, x):
        ...
        spatial_feat = self.spatial_conv2(spatial_feat + x)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
        ...
        fft_feat = rearrange(fft_feat, 'b (c d) h w -> b c h w d', d=2).contiguous()                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
