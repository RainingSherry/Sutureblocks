...
class WindowStd(nn.Module):
    ...
    def __init__(self, kernel_size=3, channels=None, eps=1e-5):
        ...
        if isinstance(kernel_size, int):
            ...
            assert len(kernel_size) == 2, "kernel_size必须是整数或二元组"                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe 独家整理!
        ...
        self.padding = (self.kernel_size[0] // 2, self.kernel_size[1] // 2)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe 独家整理!
    ...
    def forward(self, x):
        ...
        if self.channels is None:
            ...
            assert self.channels == channels, f"输入通道数({channels})与初始化通道数({self.channels})不匹配"                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe 独家整理!
        
        # 镜像padding
        x_padded = F.pad(x, 
                        pad=(self.padding[1], self.padding[1],  # 左右padding                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe 独家整理!
        ...
        x_squared_padded = F.pad(x_squared, 
                                pad=(self.padding[1], self.padding[1],                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe 独家整理!
                                     self.padding[0], self.padding[0]),                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe 独家整理!
                                mode='reflect')
        ...
        std = torch.sqrt(torch.clamp(mean_squared - mean** 2, min=self.eps))                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe 独家整理!
