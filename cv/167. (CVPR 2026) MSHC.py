...
class ChannelShuffle(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.view(batch_size, self.groups, channels // self.groups, height, width)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
        # 步骤2: 转置两个分组维度
...
class MSHC(nn.Module):
    ...
    def __init__(self, in_channels, groups=4, dilated_rate=2):
        ...
        self.branch_dwc3 = nn.Sequential(
            nn.Conv2d(in_channels, in_channels, kernel_size=3, padding=1, groups=in_channels, bias=False),                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
            nn.BatchNorm2d(in_channels),
            nn.ReLU(inplace=True)
        )
        ...
        self.branch_dwc5 = nn.Sequential(
            nn.Conv2d(in_channels, in_channels, kernel_size=5, padding=2, groups=in_channels, bias=False),                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
            nn.BatchNorm2d(in_channels),
            nn.ReLU(inplace=True)
        )
...
if __name__ == "__main__":
    ...
    model = MSHC(in_channels=32, groups=4, dilated_rate=2).to(device)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
