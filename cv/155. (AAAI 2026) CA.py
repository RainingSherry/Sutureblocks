...
class Linear(nn.Linear):
    ...
    def __init__(self, in_features, out_features, device=None, dtype=None):
        super(Linear, self).__init__(in_features, out_features, False, device, dtype)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
...
class CirculantAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Prepare Q, K, V, T
        #    (1) qkv=fc(x), qkv=fft(qkv) is mathematically equivalent to x=fft(x), qkv=fc(x)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
        #    (2) The latter requires fewer FFT computations, delivering higher throughput                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, 独家整理!
        t = self.gate(x)
        x = x.reshape(b, h, w, c)
