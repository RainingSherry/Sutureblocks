...
class DCMM(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0.):                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
        super().__init__()
        ...
        self.cp_bias_scale = nn.Parameter(torch.tensor(10,  dtype=torch.float32))                                                                                                                                                                                             # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
        self.n_clusters = 100
        ...
        self.affinity_B = nn.Parameter(torch.randn(self.num_heads, self.n_clusters, self.n_clusters)  )                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!

    def forward(self, x, cp_dcmm = 1):
        
        B, N, C = x.shape
        qkv = self.qkv(x).reshape(B, N, 3, self.num_heads, C // self.num_heads).permute(2, 0, 3, 1, 4)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
        ...
        if cp_dcmm:
            ...
            B_aff = F.sigmoid(self.affinity_B).unsqueeze(0).expand(B, -1, -1, -1)  # [B, H, K, K]                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
            ...
            z_constraint = - (z * torch.log(z + 1e-8)).sum(dim=-1).mean()                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
