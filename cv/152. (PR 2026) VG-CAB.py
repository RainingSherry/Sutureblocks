...
class CrossAttention_M(nn.Module):
    ...
    def forward(self, x):
        ...
        rgb_k = rearrange(rgb_k, 'b (head c) h w -> b head c (h w)', head=self.num_heads)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFennghe 独家整理!
        ...
        out_ir = rearrange(out_ir, 'b head c (h w) -> b (head c) h w', head=self.num_heads, h=h, w=w)                                                                                                                           # 哔哩哔哩/微信公众号: CV缝合救星, CVFennghe 独家整理!
