...
class MCA(nn.Module):
    def __init__(self, dim, num_heads, bias):
        ...
        # a: anchor information (reduced spatial information and channel information)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
    ...
    def forward(self, x):
        ...
        q = rearrange(q, 'b (head c) h w -> b head c (h w)', head=self.num_heads)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
        k = rearrange(k, 'b (head c) h w -> b head c (h w)', head=self.num_heads)                                                                                                                                                                                                                          # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!                                                                                                                                                              # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
        v = rearrange(v, 'b (head c) h w -> b head c (h w)', head=self.num_heads)
        a = rearrange(a, 'b (head c) h w -> b head c (h w)', head=self.num_heads)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
        ...
        out = rearrange(out, 'b head c (h w) -> b (head c) h w', head=self.num_heads, h=h, w=w)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星, CVFenghe, CV缝合救星, CVFenghe独家整理!
