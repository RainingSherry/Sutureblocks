...
创新魔改：通道混合增强模块（CMEM）： 通过引入CMEM模块，模型可以结合全局上下文信息和学习到的缩放因子，动态增强重要特征，
从而在复杂背景中更好地检测目标，提高整体性能。
"""
...
class GlobalContextFeatureEnhancement(nn.Module):
    def __init__(self, in_channels, reduction=16):
        super(GlobalContextFeatureEnhancement, self).__init__()
...
class PPA(nn.Module):
    def __init__(self, in_features, filters) -> None:
        ...
        self.gcfe = GlobalContextFeatureEnhancement(filters)
