...
class WDA(nn.Module):
    ...
    def window_attention(self, q, k, v):
        ...
        relative_position_bias = self.relative_position_bias_table[self.relative_position_index.view(-1)]                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
        relative_position_bias = relative_position_bias.view(N, N, -1).permute(2,0,1).unsqueeze(0)  # (1, head, N, N)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
    ...
    def forward(self, x):
        ...
        q = q.view(B_win, self.num_heads, Cq//self.num_heads, ws*ws)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
        k = k.view(B_win, self.num_heads, Cq//self.num_heads, ws*ws)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
        v = v.view(B_win, self.num_heads, Cq//self.num_heads, ws*ws)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
...
if __name__ == "__main__":
    ...
    model = WDA(dim=32, input_resolution = image_size, window_size=8, shift_size=4, num_heads=4, bias=False).to(device)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
