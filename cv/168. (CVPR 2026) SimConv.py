...
def lcm_multiple(numbers):
    ...
    for num in numbers[1:]:
        current_lcm = lcm(current_lcm, num)                                                                                                                                                                                            # 哔哩哔哩/微信公众号:CV缝合救星独家整理!
    return current_lcm
...
class SimConv(nn.Module):
    def __init__(
        ...
        self.candidate_kernels = candidate_kernels                                                                                                                                                                                            # 哔哩哔哩/微信公众号:CV缝合救星独家整理!
        ...
        self.conv_k1 = nn.Conv2d(
            ...
            kernel_size=candidate_kernels[0], padding=candidate_kernels[0]//2                                                                                                                                                                                            # 哔哩哔哩/微信公众号:CV缝合救星独家整理!
        )  # 基准核 K1 (1x1)
        self.conv_k2 = nn.Conv2d(
            in_channels, out_channels, 
            kernel_size=candidate_kernels[1], padding=candidate_kernels[1]//2                                                                                                                                                                                            # 哔哩哔哩/微信公众号:CV缝合救星独家整理!
        )  # 大核 K2 (3x3)
    ...
    def _cosine_similarity(self, x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:                                                                                                                                                                                            # 哔哩哔哩/微信公众号:CV缝合救星独家整理!
        """
        计算通道维度的余弦相似度 
        x, y: (B, C, H, W)
        return: (B, 1, H, W)
    ...
    def forward(self, I: torch.Tensor) -> torch.Tensor:
        ...
        # ==============================================================================
        M_x = (torch.abs(R_x) < self.R_theta).float()  # x 方向相关性掩码                                                                                                                                                                                            # 哔哩哔哩/微信公众号:CV缝合救星独家整理!
        ...
        # ==============================================================================
        I_proj = self.proj_I(I)  # 投影输入到输出通道用于相似度计算                                                                                                                                                                                            # 哔哩哔哩/微信公众号:CV缝合救星独家整理!
