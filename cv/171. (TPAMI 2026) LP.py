...
class AttentionBlock(nn.Module):
    def __init__(self, input=3, output=3, bias=True):
        ...
        self.conv3 = nn.Conv2d(input + 2 * 32, output, 3, 1, 1, bias=bias)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
...
class LP(nn.Module):
    def __init__(self, in_channel=3, att_channel=3,  width=16, bias=True):                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
        ...
        self.conv3 = nn.Conv2d(width+att_channel,width , 3, 1, 1, bias=bias)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
...
if __name__ == "__main__":
    ...
    model = LP(in_channel=3, att_channel=3,  width=16, bias=True).to(device)                                                                                                                                                                                            # 哔哩哔哩/微信公众号: CV缝合救星独家整理!
